    ...
    return(
      <motion.dev variants={fadeIn(
        "up", "spring", index * 0.5 , 0.75
            ...
            className="bg-tertiary  border-2 p-5 rounded-2xl sm:w-[360px] w-full">
              <div className="relative w-full h-[230px]">
                ...
                <div className="absolute inset-0 flex justify-end m-3 card-img_hover ">
                  ...
                  {/* you can create another icon for live demo from here */}
                  <div 
                  ...
                  src={demo}
                  alt='live demo '
                  className='w-1/2 h-1/2 object-contain bg-black rounded '
                  />
                  </div>
